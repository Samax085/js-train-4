...
function compareCharCodeAtAndCodePointAt(string, index) {
  // let charAtResult = charAt(string, index);// Використовуємо метод charAt(), щоб отримати символ з рядка на певній позиції, та запишемо результат в змінну charAtResult
  // let atResult = at(string, index);// Використовуємо метод at(), щоб отримати символ з рядка на певній позиції, та запишемо результат в змінну atResult
  // let charCodeAtResult = charCodeAt(string, index);// Використовуємо метод charCodeAt(), щоб отримати код символа з рядка на певній позиції, та запишемо результат в змінну charCodeAtResult
  // let codePointAtResult = codePointAt(string, index)// Використовуємо метод codePointAt(), щоб отримати код символа з рядка на певній позиції, та запишемо результат в змінну codePointAtResult
  // return `charAt:${charAtResult}` // Повертаємо рядок в форматі  `charCodeAt:${charCodeAtResult}, codePointAt:${codePointAtResult}, charAt:${charAtResult}, at:${atResult}`
}
